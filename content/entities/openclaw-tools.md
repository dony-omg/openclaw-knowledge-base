...
Tools là các năng lực mà agent có thể gọi để làm việc ngoài việc chỉ trả lời bằng text.
...
Tools biến agent từ một chat model thành một hệ thống có thể hành động.
